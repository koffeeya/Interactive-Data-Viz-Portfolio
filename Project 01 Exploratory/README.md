...
3. Then, I’ll use the `scikit-image` and `numpy` libraries to loop through the pixels in each Thumbnail image and get the average `R`, `G`, and `B` value of the image.
